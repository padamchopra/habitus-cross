...
class DevTesting {
  ...
  static Map<bool, Map<String, MyHabit>> getInitialHabits() {
    Map<String, MyHabit> activeHabits = {
      "habitId0": habit("Pushups", "As many as you can.", 18, 0, false, 0),
      "habitId1": habit("Drink More Water", "At regular intervals.", 12, 1, false, 1),
      "habitId2": habit("Practice French", "Duolingo", 0, -1, false, 2),
      "habitId3": habit("CoD", "", 0, -1, false, 3)
    };
  ...
  static Map<String, MyCategory> getInitialCategories() {
    return {
      "categoryId0": category(3, "Fitness", Icons.fitness_center, 0, 1),
      "categoryId1": category(1, "Health", Icons.healing, 1, 1)
    };
  }
}
