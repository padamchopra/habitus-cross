...
class HabitTileUnderCategory extends StatefulWidget {
  final MyHabit myHabit;
  final MyCategory myCategory;
  HabitTileUnderCategory(this.myHabit, this.myCategory);
  @override
  State<StatefulWidget> createState() {
    return _HabitTileUnderCategory();
  }
}

class _HabitTileUnderCategory extends State<HabitTileUnderCategory> {
